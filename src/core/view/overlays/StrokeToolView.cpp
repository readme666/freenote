...
void StrokeToolView::on(StrokeToolView::PredictionReplacementRequest, const std::vector<Point>&) {
    // Only PredictiveStrokeToolView consumes transient prediction points.
}
