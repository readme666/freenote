...
public:
    ...
    double getStabilizerMinCutoff() const;
    double getStabilizerBeta() const;
    double getStabilizerPredictionTime() const;
    ...
    void setStabilizerMinCutoff(double minCutoff);
    void setStabilizerBeta(double beta);
    void setStabilizerPredictionTime(double predictionTime);
...
private:
    ...
    double stabilizerMinCutoff{};
    double stabilizerBeta{};
    double stabilizerPredictionTime{};
